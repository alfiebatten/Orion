          ...
          (n = [
            {
              ...
              value: function() {
                ...
                document.addEventListener("keydown", function(e) {
                  if (
                    t.simpleKeyboardInstance.options.physicalKeyboardHighlight
                  ) {
                    var n = t.getSimpleKeyboardLayoutKey(e);
                    t.simpleKeyboardInstance.dispatch(function(e) {
                      t.simpleKeyboardInstance.options.onKeyPress(
                        e.getButtonElement(n).getElementsByTagName("span")[0]
                          .innerHTML
                      );
                      var i =
                        e.getButtonElement(n) ||
                        e.getButtonElement("{".concat(n, "}"));
                      i &&
                        ((i.style.backgroundColor =
                          t.simpleKeyboardInstance.options
          ...
          (n = [
            {
              ...
              value: function(t) {
                var e =
                  ...
                  i = "";
                return (
                  "standardBtn" !== e && (i = " hg-button-".concat(n)),
                  "hg-".concat(e).concat(i)
                );
              }
            },
            {
            ...
            },
            {
              key: "updateCaretPos",
              value: function(t, e) {
                var n = this.updateCaretPosAction(
            ...
            },
            {
              ...
              value: function(t, e, n) {
                return (
                  n
                    ? t.caretPosition > 0 &&
                      (t.caretPosition = t.caretPosition - e)
                    : (t.caretPosition = t.caretPosition + e),
            ...
            },
            {
              ...
              value: function(t, e, n, i) {
                ...
                return (
                  n || 0 === n
                    ? ((o = [t.slice(0, n), e, t.slice(n)].join("")),
                ...
                return (
                  e && e >= 0
                    ? t.substring(e - 2, e).match(o)
                      ? ((i = t.substr(0, e - 2) + t.substr(e)),
                        n && this.updateCaretPos(2, !0))
                      : ((i = t.substr(0, e - 1) + t.substr(e)),
      ...
      var p = (function() {
        function t() {
          ...
          if (
            ...
            (this.handleButtonMouseDown = this.handleButtonMouseDown.bind(
              this
            )),
            ...
            throw (console.warn('"'.concat(n, '" was not found in the DOM.')),
              ...
              value: function(t) {
                ...
                if (
                  ...
                  if (
                    ...
                    this.utilities.handleMaxLength(this.input, this.options, n)
                  )
                    return !1;
                  (this.input[
                  ...
                  (t.split(" ").forEach(function(t, i) {
                    n.options.buttonTheme.map(function(i, o) {
                      if ((e && e.includes(i.class)) || !e) {
                        ...
                        s.length
                          ? (i.buttons = s.join(" "))
                          : (n.options.buttonTheme.splice(o, 1), (i = null));
                      }
                      return i;
                    });
                  }),
                  ...
                  (this.options.modules.forEach(function(e) {
                    ...
                    if (
                      ...
                      t.keyboardPluginClasses =
                        t.keyboardPluginClasses + " ".concat(i);
                    }
                    n.init(t);
                  }),
                  (this.keyboardPluginClasses =
              ...
              value: function() {
                ...
                Array.isArray(this.options.buttonTheme) &&
                      ...
                      ? ("string" === typeof e.buttons &&
                        ...
                        n &&
                          n.forEach(function(n) {
                            var i = o[n];
                            i
                              ? t.utilities.countInArray(
                                  i.split(" "),
                                  e.class
                                ) || (o[n] = "".concat(i, " ").concat(e.class))
                              : (o[n] = e.class);
                          }))
                      : console.warn(
                  ...
                  (this.keyboardDOM.className += " "
                    .concat(this.options.theme, " ")
                    .concat(e, " ")
                    .concat(this.keyboardPluginClasses)),
                    ...
                    (a.className += "hg-row"),
                      s.forEach(function(e, s) {
                        var u = t.utilities.getButtonClass(e),
                          r = o[e],
                          c = t.utilities.getButtonDisplayName(
                            e,
                            t.options.display,
                          ...
                          i
                            ...
                            : ((h.onclick = function() {
                              ...
                              (h.onmousedown = function(n) {
                                t.options.preventMouseDownDefault &&
                                  n.preventDefault(),
                                  t.handleButtonMouseDown(e, n);
                              })),
                        ...
                        var d = ""
                          ...
                          .concat(n, "b")
                          .concat(s);
                        h.setAttribute("data-skBtnUID", d),
                          h.setAttribute("data-displayLabel", c);
